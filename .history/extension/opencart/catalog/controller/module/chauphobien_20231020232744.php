 ...
 * @package
 */
class Chauphobien extends \Opencart\System\Engine\Controller {
	/**
	 * @param array $setting
	 *
	 * @return string
	...
	public function index(array $setting): string {
		$this->load->language('extension/opencart/module/chauphobien');
		...
		if ($data['products']) {
			return $this->load->view('extension/opencart/module/chauphobien', $data);
		} else {
			return '';
		}
	}
